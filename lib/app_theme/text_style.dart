...
class MyTextStyle{
  ...
  static TextStyle headings = TextStyle(fontSize: 16, color: MyColors.primaryColor);
  static TextStyle subheadings = TextStyle(fontSize: 14, color: MyColors.primaryColor);
