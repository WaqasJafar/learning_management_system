...
class BsInternationalRelation extends StatefulWidget {
  const BsInternationalRelation({Key key}) : super(key: key);

  @override
  _BsInternationalRelationState createState() => _BsInternationalRelationState();
}

class _BsInternationalRelationState extends State<BsInternationalRelation> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const Center(
              child: Text(
                'Garrison University Subject Portal',
                style: TextStyle(
                    color: Colors.white,
                    fontSize: 20,
            ...
            const Text(
              'International Relation Semester System',
              style: TextStyle(
                  color: Colors.white,
                  fontSize: 20,
                  fontWeight: FontWeight.bold),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'IR: 1648-1945 Geo_Political Structure',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'International Relation: 1945-2000',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Regional & International Organizational',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Comparative & Development Political ',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Comparatives Foreign Policy Of Major Power',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'International Relation in The New Millennium',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
