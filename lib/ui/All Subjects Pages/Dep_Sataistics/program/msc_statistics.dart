...
class MSCStatistics extends StatefulWidget {
  const MSCStatistics({Key key}) : super(key: key);

  @override
  _MSCStatisticsState createState() => _MSCStatisticsState();
}

class _MSCStatisticsState extends State<MSCStatistics> {
  @override
          ...
          children: [
            ...
            Column(
              children: const [
                ...
                Text(
                  "Department of M.SC Statistics Semester System",
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Thesis/One Optional Course from B',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
