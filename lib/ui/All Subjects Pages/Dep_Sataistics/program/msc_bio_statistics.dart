...
class MSCBioStatistics extends StatefulWidget {
  const MSCBioStatistics({Key key}) : super(key: key);

  @override
  _MSCBioStatisticsState createState() => _MSCBioStatisticsState();
}

class _MSCBioStatisticsState extends State<MSCBioStatistics> {
  @override
          ...
          children: [
            ...
            Column(
              children: const [
                ...
                Text(
                  "Department of M.SC Bio Statistics Semester System",
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold),
