...
class MSCMicrobiology extends StatefulWidget {
  const MSCMicrobiology({Key key}) : super(key: key);

  @override
  _MSCMicrobiologyState createState() => _MSCMicrobiologyState();
}

class _MSCMicrobiologyState extends State<MSCMicrobiology> {
  @override
          ...
          children: [
            ...
            Column(
              children: const [
                ...
                Text(
                  "Department of M.SC Microbiology Semester System",
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Internship/ Thesis OR Special Papers',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
