...
class BSBiotechnology extends StatefulWidget {
  const BSBiotechnology({Key key}) : super(key: key);

  @override
  _BSBiotechnologyState createState() => _BSBiotechnologyState();
}

class _BSBiotechnologyState extends State<BSBiotechnology> {
  @override
          ...
          children: [
            ...
            Column(
              children: const [
                ...
                Text(
                  "Department of Biotechnology Semester System",
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Research Methodology & Skills Enhancement',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Principle of Biochemical-Engineering',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
