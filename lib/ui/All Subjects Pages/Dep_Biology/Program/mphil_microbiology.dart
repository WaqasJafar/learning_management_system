...
class MPHILMicrobiology extends StatefulWidget {
  const MPHILMicrobiology({Key key}) : super(key: key);

  @override
  _MPHILMicrobiologyState createState() => _MPHILMicrobiologyState();
}

class _MPHILMicrobiologyState extends State<MPHILMicrobiology> {
  @override
          ...
          children: [
            ...
            Column(
              children: const [
                ...
                Text(
                  "Department of M.Phil Microbiology Semester System",
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold),
                ...
                children: [
                  const Padding(
                    ...
                    child: Align(
                        ...
                        child: Text('Compulsory Subjects',
                            style: TextStyle(
                                color: Colors.white,
                                fontWeight: FontWeight.bold,
                                fontSize: 20,
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Laboratory Method in Microbiology',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
