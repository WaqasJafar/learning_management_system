...
class BSMicroBiology extends StatefulWidget {
  const BSMicroBiology({Key key}) : super(key: key);

  @override
  _BSMicroBiologyState createState() => _BSMicroBiologyState();
}

class _BSMicroBiologyState extends State<BSMicroBiology> {
  @override
          ...
          children: [
            ...
            Column(
              children: const [
                ...
                Text(
                  "Department of Microbiology Semester System",
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Bio Membranes and Cell Signaling',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Antimicrobial and Chemotherapeutics',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
