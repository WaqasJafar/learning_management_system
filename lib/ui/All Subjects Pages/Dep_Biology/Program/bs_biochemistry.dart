...
class BSBioChemistry extends StatefulWidget {
  const BSBioChemistry({Key key}) : super(key: key);

  @override
  _BSBioChemistryState createState() => _BSBioChemistryState();
}

class _BSBioChemistryState extends State<BSBioChemistry> {
  @override
          ...
          children: [
            ...
            Column(
              children: const [
                ...
                Text(
                  "Department of Biology Semester System",
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold),
