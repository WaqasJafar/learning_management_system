...
class BsEnglish extends StatefulWidget {
  const BsEnglish({Key key}) : super(key: key);

  @override
  _BsEnglishState createState() => _BsEnglishState();
}

class _BsEnglishState extends State<BsEnglish> {
  @override
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'English 1: Reading and Writing Skills',
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Introduction to information and Computer Technology Skills',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
