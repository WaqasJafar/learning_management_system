...
class BSDataScience extends StatefulWidget {
  const BSDataScience({Key key}) : super(key: key);

  @override
  _BSDataScienceState createState() => _BSDataScienceState();
}

class _BSDataScienceState extends State<BSDataScience> {
  @override
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            const Expanded(
                              child: Text("2", style: const TextStyle(fontSize: 20)),
                            ),
                            const SizedBox(
                              width: 40,
                            ),
