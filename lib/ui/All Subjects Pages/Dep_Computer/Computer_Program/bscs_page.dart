...
class BSComputerScience extends StatefulWidget {
  const BSComputerScience({Key key}) : super(key: key);

  @override
  _BSComputerScienceState createState() => _BSComputerScienceState();
}

class _BSComputerScienceState extends State<BSComputerScience> {
  @override
          ...
          children: [
            ...
            Column(
              children: const [
                ...
                Text(
                  "Computer Science Semester System",
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold),
