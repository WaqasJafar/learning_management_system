...
class MSComputer extends StatefulWidget {
  const MSComputer({Key key}) : super(key: key);

  @override
  _MSComputerState createState() => _MSComputerState();
}

class _MSComputerState extends State<MSComputer> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const Text(
              'Master in Computer Science Schedule',
              style: TextStyle(
                  color: Colors.white,
                  fontSize: 20,
                  fontWeight: FontWeight.bold),
