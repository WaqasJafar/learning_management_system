...
class MSCMassCom extends StatefulWidget {
  const MSCMassCom({Key key}) : super(key: key);

  @override
  _MSCMassComState createState() => _MSCMassComState();
}

class _MSCMassComState extends State<MSCMassCom> {
  @override
          ...
          children: [
            ...
            Column(
              children: const [
                ...
                Text(
                  "Department of Mass Com Semester System",
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Issue of International Communication',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
