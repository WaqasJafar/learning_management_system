...
class BSCyberSecurity extends StatefulWidget {
  const BSCyberSecurity({Key key}) : super(key: key);

  @override
  _BSCyberSecurityState createState() => _BSCyberSecurityState();
}

class _BSCyberSecurityState extends State<BSCyberSecurity> {
  @override
          ...
          children: [
            ...
            Column(
              children: const [
                ...
                Text(
                  "Cyber Security Semester System",
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold),
