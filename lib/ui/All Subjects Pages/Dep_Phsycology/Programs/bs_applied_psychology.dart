...
class BSAppliedPsychology extends StatefulWidget {
  const BSAppliedPsychology({Key key}) : super(key: key);

  @override
  _BSAppliedPsychologyState createState() => _BSAppliedPsychologyState();
}

class _BSAppliedPsychologyState extends State<BSAppliedPsychology> {
  @override
