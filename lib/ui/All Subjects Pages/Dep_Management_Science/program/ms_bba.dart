...
class MSBusiness extends StatefulWidget {
  const MSBusiness({Key key}) : super(key: key);

  @override
  _MSBusinessState createState() => _MSBusinessState();
}

class _MSBusinessState extends State<MSBusiness> {
  @override
          ...
          children: [
            ...
            Column(
              children: const [
                ...
                Text(
                  "Department of MS(BA) Semester System",
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold),
