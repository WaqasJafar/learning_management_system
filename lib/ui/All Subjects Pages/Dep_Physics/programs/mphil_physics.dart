...
class MPHILPhysics extends StatefulWidget {
  const MPHILPhysics({Key key}) : super(key: key);

  @override
  _MPHILPhysicsState createState() => _MPHILPhysicsState();
}

class _MPHILPhysicsState extends State<MPHILPhysics> {
  @override
          ...
          children: [
            ...
            Column(
              children: const [
                ...
                Text(
                  "Department of M.Phil Physics Semester System",
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold),
