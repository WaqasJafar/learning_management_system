...
class PHDPhysics extends StatefulWidget {
  const PHDPhysics({Key key}) : super(key: key);

  @override
  _PHDPhysicsState createState() => _PHDPhysicsState();
}

class _PHDPhysicsState extends State<PHDPhysics> {
  @override
          ...
          children: [
            ...
            Column(
              children: const [
                ...
                Text(
                  "Department of Ph.D Physics Semester System",
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Advance Mathematical Method of Physics',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
