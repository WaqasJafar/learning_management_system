...
class BSPhysics extends StatefulWidget {
  const BSPhysics({Key key}) : super(key: key);

  @override
  _BSPhysicsState createState() => _BSPhysicsState();
}

class _BSPhysicsState extends State<BSPhysics> {
  @override
          ...
          children: [
            ...
            Column(
              children: const [
                ...
                Text(
                  "Department of Physics Semester System",
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Electronics Devices and Circuts ',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Fundamentals of Linear Physics',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
