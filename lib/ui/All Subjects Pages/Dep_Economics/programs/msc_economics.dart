...
class MSCEconomics extends StatefulWidget {
  const MSCEconomics({Key key}) : super(key: key);

  @override
  _MSCEconomicsState createState() => _MSCEconomicsState();
}

class _MSCEconomicsState extends State<MSCEconomics> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const Text(
              'Department of Economics Schedule',
              style: TextStyle(
                  color: Colors.white,
                  fontSize: 20,
                  fontWeight: FontWeight.bold),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Major Issue on Pakistan Economy',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Computer Application in Quantitative Analysis in Economics',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
