...
class BSEconomics extends StatefulWidget {
  const BSEconomics({Key key}) : super(key: key);

  @override
  _BSEconomicsState createState() => _BSEconomicsState();
}

class _BSEconomicsState extends State<BSEconomics> {
  @override
          ...
          children: [
            ...
            Column(
              children: const [
                ...
                Text(
                  "Department Economics Semester System",
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                              'Major Issue of Pakistan Economy',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
