...
class MSCMathematics extends StatefulWidget {
  const MSCMathematics({Key key}) : super(key: key);

  @override
  _MSCMathematicsState createState() => _MSCMathematicsState();
}

class _MSCMathematicsState extends State<MSCMathematics> {
  @override
          ...
          children: [
            ...
            Column(
              children: const [
                ...
                Text(
                  "Department of Mathematics Semester System",
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold),
