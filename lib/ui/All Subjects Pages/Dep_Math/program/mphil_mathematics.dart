...
class MPHILMathematics extends StatefulWidget {
  const MPHILMathematics({Key key}) : super(key: key);

  @override
  _MPHILMathematicsState createState() => _MPHILMathematicsState();
}

class _MPHILMathematicsState extends State<MPHILMathematics> {
  @override
          ...
          children: [
            ...
            Column(
              children: const [
                ...
                Text(
                  "Department of M.Phil Mathematics Semester System",
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Dynamics Equations on time Skills',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Perturbation Method in Fluid Mechanism',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
