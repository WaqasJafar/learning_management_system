...
class BSMathematics extends StatefulWidget {
  const BSMathematics({Key key}) : super(key: key);

  @override
  _BSMathematicsState createState() => _BSMathematicsState();
}

class _BSMathematicsState extends State<BSMathematics> {
  @override
          ...
          children: [
            ...
            Column(
              children: const [
                ...
                Text(
                  "Department of Mathematical Semester System",
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Introduction to Economics (Optioanl)',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
