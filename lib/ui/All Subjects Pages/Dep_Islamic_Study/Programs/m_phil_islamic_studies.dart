...
class MPhilIslamicStudy extends StatefulWidget {
  const MPhilIslamicStudy({Key key}) : super(key: key);

  @override
  _MPhilIslamicStudyState createState() => _MPhilIslamicStudyState();
}

class _MPhilIslamicStudyState extends State<MPhilIslamicStudy> {
  @override
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Analytical Study of Orientation',
                                style: GoogleFonts.ubuntu(
                                  fontSize: Dimensions.defaultText,
                                ),
                              ),
