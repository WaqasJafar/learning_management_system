...
class MscChemistry extends StatefulWidget {
  const MscChemistry({Key key}) : super(key: key);

  @override
  _MscChemistryState createState() => _MscChemistryState();
}

class _MscChemistryState extends State<MscChemistry> {
  @override
